...
unsigned char operation_mode,reset_flag,convec_mode_op,start_flag;
...
void main(void) {
    ...
    while (1) {
        ...
        else if (key == 1 && (operation_mode != 0x05))
        {
           operation_mode = 0x02;
           reset_flag = 0x10;
           clear_clcd();
        ...
        else if (key == 2 && (operation_mode != 0x05))
        {
            operation_mode = 0x03;
            reset_flag = 0x10;
            clear_clcd();
        ...
        else if (key == 4 )
        {
            ...
            else if ((operation_mode == 0x05) && (start_flag == 0XAF))
            {
        ...
        switch(operation_mode)
        {
            ...
            case 0x04:
                if (convec_mode_op == 0X09)
                {
                    set_temp(key);
                    if(convec_mode_op == 0X0A)
                    {
                      continue;
                    }
                }
                else if (convec_mode_op == 0X0A)
                {
                    set_time(key);
...
void set_temp(unsigned char key)
{
    ...
    if( reset_flag == 0x11)
    {
        ...
        blink = 0;
        key_count = 0;
        clcd_print(" SET TEMP ( C)",(0x80 + 0));
        clcd_putch(0XDF,(0x80 + 11));
